...
<div class="container">
  ...
  <div class="container_first" ref="home">
    ...
    <div class="main" data-aos="zoom-in">
      <div class="main-text">
        <h1 class="main-text_title">Hello,</h1>
